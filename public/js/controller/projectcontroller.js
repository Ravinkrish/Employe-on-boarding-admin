singapp.controller("projectCtrl", function ($scope, projectService, fromService,projectclientService,employeeService) {
...
$scope.projectStatusList = [];
   ...
   $scope.projectStatusList=[{name:"Active"},{name:"Inactive"},{name:"Production"},{name:"Maintanence"},{name:'Slack'}];
}
