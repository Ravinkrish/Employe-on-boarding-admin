...
userallmytimesheetsFromConfig=require('../fromConfig/userdailytask.json')
...
userallmytimesheetsDetailsModel.findOneAndUpdate({_id:req.params.mongoid},{"isapproved":true},function(err,result){
 if (err){
            console.log('Error in Saving user: '+err);
        }
        res.send(result);
...
router.post('/disAppreoveEmployeeDailyTask/:mongoid',function(req,res){
userallmytimesheetsDetailsModel.findOneAndUpdate({_id:req.params.mongoid},{"isapproved":false},function(err,result){
 if (err){
            console.log('Error in Saving user: '+err);
        }
        res.send(result);
